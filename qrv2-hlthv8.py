...
try:
    ...
    if result["status"] != 200:
        raise Exception("Timeout!!!")
    kd = LINE(result["result"]["token"], appName="IOSIPAD\t9.18.1\tiPhone X\t12.4.1")
    print("Login Sukses")
except BaseException:
    pass
...
try:
    ...
    if result["status"] != 200:
        raise Exception("Timeout!!!")
    st = LINE(result["result"]["token"], appName="IOSIPAD\t9.18.1\tiPhone X\t12.4.1")
    print("Login Sukses")
except BaseException:
    pass
...
try:
    ...
    if result["status"] != 200:
        raise Exception("Timeout!!!")
    su = LINE(result["result"]["token"], appName="IOSIPAD\t9.18.1\tiPhone X\t12.4.1")
    print("Login Sukses")
except BaseException:
    pass
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            try:
                                                ...
                                                try:
                                                    su.kickoutFromGroup(op.param1, [op.param2])
                                                except BaseException:
                                                    try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    if (
                                        kd.getGroup(op.param1).preventedJoinByTicket
                                        == False
                                    ):
                                        if (
                                            op.param2 not in Bots
            ...
            if Dmid in op.param3:
                if wait["autoJoin"]:
                    if (
                        ...
                        kd.sendMessage(op.param1, "Don't invite without my commander!")
            ...
            if wait["protectinvite"]:
                if (
                    ...
                    try:
                        ...
                        random.choice(DRE).cancelGroupInvitation(op.param1, [op.param3])
                        random.choice(DRE).kickoutFromGroup(op.param1, [op.param2])
                        random.choice(DRE).inviteIntoGroup(op.param1, [Xmid, Ymid, Zmid])
                        cl.sendMessage(op.param1, "Don't invite without permission!")
                    except BaseException:
                        try:
                            wait["blacklist"][op.param2] = True
                    ...
                    try:
                        ...
                        try:
                            if (
                                ...
                                X.preventedJoinByTicket = True
                                kk.updateGroup(X)
                                kk.inviteIntoGroup(op.param1, [Xmid, Ymid, Zmid])
                                wait["blacklist"][op.param2] = True
                        except BaseException:
                            try:
                                if (
                                    ...
                                    X.preventedJoinByTicket = True
                                    kc.updateGroup(X)
                                    kc.inviteIntoGroup(op.param1, [Xmid, Ymid, Zmid])
                                    wait["blacklist"][op.param2] = True
                            except BaseException:
                                try:
                                    if (
                                        ...
                                        X.preventedJoinByTicket = True
                                        kd.updateGroup(X)
                                        kd.inviteIntoGroup(op.param1, [Xmid, Ymid, Zmid])
                                        wait["blacklist"][op.param2] = True
                                except BaseException:
                                    pass
            ...
            if wait["protectantijs"]:
                try:
                    if (
                        ...
                        Ticket = random.choice(ghost).reissueGroupTicket(op.param1)
            ...
            if mid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        ...
                        try:
                            kk.kickoutFromGroup(op.param1, [op.param2])
                            kk.inviteIntoGroup(op.param1, [mid, Amid, Cmid, Dmid])
                            cl.acceptGroupInvitation(op.param1)
                            ki.acceptGroupInvitation(op.param1)
                            kc.acceptGroupInvitation(op.param1)
                            kd.acceptGroupInvitation(op.param1)
                            ...
                            try:
                                ...
                                try:
                                    kd.kickoutFromGroup(op.param1, [op.param2])
                                    kd.inviteIntoGroup(op.param1, [mid, Amid, Bmid, Cmid])
                                    cl.acceptGroupInvitation(op.param1)
                                    ki.acceptGroupInvitation(op.param1)
                                    kk.acceptGroupInvitation(op.param1)
                                    kc.acceptGroupInvitation(op.param1)
            ...
            if Amid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        ...
                        try:
                            kc.kickoutFromGroup(op.param1, [op.param2])
                            kc.inviteIntoGroup(op.param1, [Amid, Bmid, Dmid, mid])
                            ki.acceptGroupInvitation(op.param1)
                            kk.acceptGroupInvitation(op.param1)
                            kd.acceptGroupInvitation(op.param1)
                            cl.acceptGroupInvitation(op.param1)
                            ...
                            try:
                                kd.kickoutFromGroup(op.param1, [op.param2])
                                kd.inviteIntoGroup(op.param1, [Amid, Bmid, Cmid, mid])
                                ki.acceptGroupInvitation(op.param1)
                                kk.acceptGroupInvitation(op.param1)
                                kc.acceptGroupInvitation(op.param1)
                                cl.acceptGroupInvitation(op.param1)
                                ...
                                try:
                                    ...
                                    cl.inviteIntoGroup(op.param1, [Amid, Bmid, Cmid, Dmid])
                                    ki.acceptGroupInvitation(op.param1)
                                    kk.acceptGroupInvitation(op.param1)
                                    kc.acceptGroupInvitation(op.param1)
                                    kd.acceptGroupInvitation(op.param1)
            ...
            if Bmid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        ...
                        try:
                            kd.kickoutFromGroup(op.param1, [op.param2])
                            kd.inviteIntoGroup(op.param1, [Bmid, Cmid, mid, Amid])
                            kk.acceptGroupInvitation(op.param1)
                            kc.acceptGroupInvitation(op.param1)
                            cl.acceptGroupInvitation(op.param1)
                            ki.acceptGroupInvitation(op.param1)
                            ...
                            try:
                                cl.kickoutFromGroup(op.param1, [op.param2])
                                cl.inviteIntoGroup(op.param1, [Bmid, Cmid, Dmid, Amid])
                                kk.acceptGroupInvitation(op.param1)
                                kc.acceptGroupInvitation(op.param1)
                                kd.acceptGroupInvitation(op.param1)
                                ki.acceptGroupInvitation(op.param1)
                                ...
                                try:
                                    ki.kickoutFromGroup(op.param1, [op.param2])
                                    ki.inviteIntoGroup(op.param1, [Bmid, Cmid, Dmid, mid])
                                    kk.acceptGroupInvitation(op.param1)
                                    kc.acceptGroupInvitation(op.param1)
                                    kd.acceptGroupInvitation(op.param1)
                                    cl.acceptGroupInvitation(op.param1)
            ...
            if Cmid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        ...
                        try:
                            cl.kickoutFromGroup(op.param1, [op.param2])
                            cl.inviteIntoGroup(op.param1, [Cmid, Dmid, Amid, Bmid])
                            kc.acceptGroupInvitation(op.param1)
                            kd.acceptGroupInvitation(op.param1)
                            ki.acceptGroupInvitation(op.param1)
                            kk.acceptGroupInvitation(op.param1)
                            ...
                            try:
                                ki.kickoutFromGroup(op.param1, [op.param2])
                                ki.inviteIntoGroup(op.param1, [Cmid, Dmid, mid, Bmid])
                                kc.acceptGroupInvitation(op.param1)
                                kd.acceptGroupInvitation(op.param1)
                                cl.acceptGroupInvitation(op.param1)
                                kk.acceptGroupInvitation(op.param1)
                                ...
                                try:
                                    kk.kickoutFromGroup(op.param1, [op.param2])
                                    kk.inviteIntoGroup(op.param1, [Cmid, Dmid, mid, Amid])
                                    kc.acceptGroupInvitation(op.param1)
                                    kd.acceptGroupInvitation(op.param1)
                                    cl.acceptGroupInvitation(op.param1)
                                    ki.acceptGroupInvitation(op.param1)
            ...
            if Dmid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    try:
                        ...
                        try:
                            ki.kickoutFromGroup(op.param1, [op.param2])
                            ki.inviteIntoGroup(op.param1, [Dmid, mid, Bmid, Cmid])
                            kd.acceptGroupInvitation(op.param1)
                            cl.acceptGroupInvitation(op.param1)
                            kk.acceptGroupInvitation(op.param1)
                            kc.acceptGroupInvitation(op.param1)
                            ...
                            try:
                                kk.kickoutFromGroup(op.param1, [op.param2])
                                kk.inviteIntoGroup(op.param1, [Dmid, mid, Amid, Cmid])
                                kd.acceptGroupInvitation(op.param1)
                                cl.acceptGroupInvitation(op.param1)
                                ki.acceptGroupInvitation(op.param1)
                                kc.acceptGroupInvitation(op.param1)
                                ...
                                try:
                                    kc.kickoutFromGroup(op.param1, [op.param2])
                                    kc.inviteIntoGroup(op.param1, [Dmid, mid, Amid, Bmid])
                                    kd.acceptGroupInvitation(op.param1)
                                    cl.acceptGroupInvitation(op.param1)
                                    ki.acceptGroupInvitation(op.param1)
                                    kk.acceptGroupInvitation(op.param1)
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    try:
                                        kd.kickoutFromGroup(op.param1, [op.param2])
                                        kd.findAndAddContactsByMid(op.param1, op.param3)
                    ...
                    if text is None:
                            ...
                            if wait["selfbot"]:
                                if msg._from in admin:
                                    try:
                                        ...
                                        st.sendText(msg.to, "Chat dibersihkan...")
                                        su.sendText(msg.to, "Chat dibersihkan...")
                        ...
                        # RESPONSE
                            ...
                            if msg._from in admin:
                                ...
                                st.acceptGroupInvitationByTicket(msg.to, Ticket)
                                su.acceptGroupInvitationByTicket(msg.to, Ticket)
                                ...
                                kd.sendMessage(msg.to, "𐀀 HELLTERHEAD IS READY❗")
                                st.sendMessage(msg.to, "𐀀 HELLTERHEAD IS READY❗")
                                su.sendMessage(msg.to, "𐀀 HELLTERHEAD IS READY❗")
                        ...
                        # BOT
                            ...
                            if wait["selfbot"]:
                                if msg._from in admin:
                                    try:
                                        ginfo = cl.getGroup(msg.to)
                                        cl.inviteIntoGroup(msg.to, [Xmid, Ymid, Zmid])
                                    except BaseException:
                                        pass
